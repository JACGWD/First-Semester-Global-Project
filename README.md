...
See [evaluation criteria](evaluation-criteria.md) and [examples of previous designs](./gallery.md) as well as a [gallery of professionally designed sites for your inspiration](pro-sites-gallery.md). You can also read the [Quick Start](./quick-start.md) for an overview of the design steps.
...
7. How to [code the cards](create-cards.md)
8. Mark up your texts with [classes](./classes-and-ids.md)
9. [Simplify, prepare and optimize your SVG icons](creating-svg-icons.md)
...
13. Use [Emmet to build the form](./form.md) (that you must complete and later customize according to your needs)
14. [HTML Checklist & Evaluation Criteria](./html-checklist-and-evaluation-criteria.md)

#### CSS

15. [Basic CSS for the contact form](contact-form-css.md)
16. [Basic CSS for the navigation](./navigation-how-to.md)
17. Do your [typography](./typography.md)
18. [Format the home page cards](create-cards.md)
19. Read this overview of [design considerations](./design-considerations.md) which includes useful links and tips.